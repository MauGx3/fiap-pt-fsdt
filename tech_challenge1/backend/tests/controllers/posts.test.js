...
describe('Posts Controller', () => {
    ...
    describe('getAllPosts', () => {
        ...
        test('should handle database errors', async () => {
            ...
            const mockFind = jest.spyOn(Post, 'find').mockRejectedValue(new Error('Database error'));
    ...
    describe('updatePost', () => {
        ...
        test('should return 400 for invalid post ID', async () => {
            ...
            expect(mockRes.status).toHaveBeenCalledWith(400);
            expect(mockRes.json).toHaveBeenCalledWith({ error: 'Invalid post ID format' });
        });
    });
    ...
    describe('searchPosts', () => {
        ...
        test('should return 400 for missing query parameter', async () => {
            ...
            expect(mockRes.status).toHaveBeenCalledWith(400);
            expect(mockRes.json).toHaveBeenCalledWith({ error: 'Missing query parameter' });
        });
