...
describe('Blog API Integration Tests', () => {
  ...
  describe('Complete User Journey', () => {
    test('should handle complete user registration and posting workflow', async () => {
      ...
      expect(createPostResponse.body.post.author).toBe(registerResponse.body.user.uuid);
      ...
      const charliePost = allPostsResponse.body.find(p => p.title === postData.title);
  ...
  describe('Performance and Pagination', () => {
    ...
    test('should handle search with multiple results', async () => {
      ...
      searchResponse.body.forEach(post => {
        const hasJavaScriptInTitle = post.title.toLowerCase().includes('javascript');
        const hasJavaScriptInContent = post.content.toLowerCase().includes('javascript');
